...
export function LogoutPage({ onComplete, redirectUrl = '/login' }: LogoutPageProps) {
  ...
  const logoutMethods: LogoutMethod[] = [
    {
      ...
      description: 'Normal logout that clears your session and browser authentication. Suitable for personal devices.',
    ...
    },
    {
      id: 'soft',
      name: 'Quick Logout',
      description: 'Fast logout with minimal cleanup. Some data may remain cached in your browser.',
    ...
    },
    {
      id: 'force',
      name: 'Secure Logout',
      description: 'Complete logout that aggressively clears all browser data including cache, cookies, and storage.',
      icon: <Shield className="h-5 w-5" />,
      warning: 'This will clear all browser data for this site. Use on shared computers.',
      securityLevel: 'maximum'
    },
    {
      id: 'clear',
      name: 'Clear Authentication',
      description: 'Modern logout using browser APIs to clear site data. Good balance of security and convenience.',
  ...
  const renderSelection = () => (
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader className="text-center">
        ...
        <CardTitle className="text-2xl font-bold">Logout from Hospital System</CardTitle>
        <CardDescription>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between">
                    ...
                    <span className={`px-2 py-1 text-xs font-medium rounded-full ${getSecurityLevelColor(method.securityLevel)}`}>
                      {method.securityLevel.charAt(0).toUpperCase() + method.securityLevel.slice(1)} Security
                    </span>
                  </div>
    ...
    <Card className="w-full max-w-lg mx-auto">
      <CardContent className="pt-6">
        <div className="text-center space-y-4">
          ...
          <p className="text-sm text-gray-600">
            You have been successfully logged out from the Hospital Management System.
          </p>
            ...
            <Alert>
              ...
              <AlertDescription>
                <div className="space-y-1">
                  ...
                  {Object.entries(logoutResult.instructions).map(([key, value]) => (
                    <p key={key} className="text-xs">• {value}</p>
                  ))}
                </div>
              </AlertDescription>
            </Alert>
      ...
      <CardContent className="pt-6">
        <div className="text-center space-y-4">
          ...
          <div className="space-y-2">
            <p className="text-sm text-gray-600">
              There was an issue with the logout process, but your local data has been cleared for security.
            </p>
            {error && (
        ...
        {currentStep === 'selection' && (
          <div className="mt-6 text-center">
            <p className="text-xs text-gray-500">
              For maximum security on shared computers, use "Secure Logout" and close your browser completely.
            </p>
          </div>
        )}
      </div>
